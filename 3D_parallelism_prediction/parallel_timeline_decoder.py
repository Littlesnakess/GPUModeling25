    ...
    def get_gpu_runtime(self, item_names):
        ...
        for item_name in item_names:
            ...
            for target_item in target_items:
                ...
                print(f'cuda_runtimes: {len(cuda_runtimes)}')
...
def modules_gpu_runtime(decoder_list, save_folder):
    ...
    #             'deepspeed/runtime/pipe/engine.py(1140): _exec_optimizer_step', 
    #             'deepspeed/runtime/pipe/module.py(319): forward', 
    #             'torch/autograd/__init__.py(242): backward', 
    #             'deepspeed/runtime/pipe/engine.py(312): train_batch'
    #             ]
...
def get_p2p(path):
    # file_path = 'perlmutter/GPT_20B_4_4_8_32_4/31694544/PP4_MP4_DP8_ZERO1/0/nid001412_560029.1728564975718.pt.trace.json'
    item_name = ['nccl:send']
    # item_name = 'c10d::send'
    timelineDecoder = TimelineDecoder(path, 16)
    gpu_time = timelineDecoder.get_gpu_runtime(item_name)
    return gpu_time
...
if __name__ == "__main__":
    ...
    # path = 'perlmutter/GPT_20B_4_4_8_32_4/31694544/PP4_MP4_DP8_ZERO1/32/nid001597_1888490.1728564983928.pt.trace.json'
    # gpu_time = get_p2p(path)
    # print(gpu_time)
